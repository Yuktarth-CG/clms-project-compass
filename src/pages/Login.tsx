...
const Login = () => {
  ...
  // Only ever redirect to a same-site relative path, never an absolute/external URL.
  const safeRedirect = redirectTo && redirectTo.startsWith('/') && !redirectTo.startsWith('//') ? redirectTo : '/admin';
